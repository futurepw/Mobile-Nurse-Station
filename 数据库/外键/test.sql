...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-06-10 09:38:59
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
CREATE TABLE `orders` (
  ...
  `dosage` double(10,3) NOT NULL COMMENT '每次剂量',
...
CREATE TABLE `report` (
  ...
  `price` double(20,3) NOT NULL COMMENT '价格',
...
CREATE TABLE `signs` (
  ...
  `patient_id` varchar(20) NOT NULL COMMENT '病人',
  `temperature` double(10,3) NOT NULL COMMENT '体温',
  `breathe` double(10,3) NOT NULL COMMENT '呼吸量',
  `blood_pressureL` double(10,3) NOT NULL COMMENT '血压低',
  `blood_pressureH` double(10,3) NOT NULL COMMENT '血压高',
  `pulse` int(11) NOT NULL COMMENT '脉搏',
  `height` double(10,3) NOT NULL COMMENT '身高',
  `weight` double(10,3) NOT NULL COMMENT '体重',
  `in_out` double(10,3) NOT NULL COMMENT '出入量'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
